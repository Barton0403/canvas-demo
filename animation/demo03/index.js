...
function drawBackground2() {
  var STEP_Y = 12,
      TOP_MARGIN = STEP_Y * 4,
      LEFY_MARGIN = STEP_Y * 3,
      i = offscreenCanvas.height;

  offscreenContext.strokeStyle = 'lightgray';
  offscreenContext.lineWith = 0.5;

  while (i > TOP_MARGIN) {
    offscreenContext.beginPath();
    offscreenContext.moveTo(0, i);
    offscreenContext.lineTo(offscreenCanvas.width, i);
    offscreenContext.stroke();
    i -= STEP_Y;
  }

  offscreenContext.strokeStyle = 'rgba(100,0,0,0.3)';
  offscreenContext.lineWith = 1;
  offscreenContext.beginPath();
  offscreenContext.moveTo(LEFY_MARGIN, 0);
  offscreenContext.lineTo(LEFY_MARGIN, offscreenCanvas.width);
  offscreenContext.stroke();
}
